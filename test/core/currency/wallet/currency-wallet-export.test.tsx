...
} from '../../../../src/core/currency/wallet/currency-wallet-export'
import { EdgeTransaction } from '../../../../src/index'
...
describe('transaction export formats', function () {
  ...
  it('matches QBO reference data', function () {
