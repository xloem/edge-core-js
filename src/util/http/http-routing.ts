import { HttpResponse, Server } from './http-types'
 ...
 */
export function pickPath<T extends { readonly path: string }>(routes: {
 ...
 */
export function pickServer<T>(...servers: Array<Server<T>>): Server<T> {
